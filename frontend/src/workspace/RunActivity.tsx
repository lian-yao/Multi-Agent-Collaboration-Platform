 ...
 *
 * 界面**不写口径脚注**：原先卡片底部有「本次任务：…」与「这里显示的是编排层落盘的执行链路…」
 * 两条，已按评审删除——卡片本身只呈现落盘过的事实，再复述一遍任务原文与口径属于噪音；
 * 需要这条口径说明时去执行台弹窗看（那里是独立窗口，缺了上下文反而读不懂）。
 * **别把这两条当成漏了又加回去**，`workspace-smoke` 里有断言盯着它们不回来。
 *
